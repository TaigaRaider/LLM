    ...
    <div className="min-h-screen bg-slate-100 flex items-center justify-center px-4">
      <div className="q-rise w-full max-w-sm bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
        <div className="flex items-center gap-2.5 mb-6">
          ...
          <div>
            <div className="font-semibold text-slate-900 tracking-tight leading-tight">LLM</div>
        ...
        <p className="text-sm text-slate-500 mb-5">Use the officer account issued to you.</p>
